...
/**
 * Created by ediperturk on 1.06.2017.
 */

public class RNReactNativeLocationListener implements LocationListener{

    private ReactContext reactContext;
    private RNReactNativeFactory reactNativeFactory;

    public RNReactNativeLocationListener(ReactContext reactContext, RNReactNativeFactory reactNativeFactory) {
